...
#ifndef STM32F0XX_SIMPLE_GPIO_H_INCLUDED
#define STM32F0XX_SIMPLE_GPIO_H_INCLUDED
...
#define GPIO_output_push_pull_fast(port,pins)                          GPIO_setup ((port), (pins), 1, (       0), 0,   0,  3)
...
#define GPIO_output_open_drain_fast(port,pins)                         GPIO_setup ((port), (pins), 1, (       0), 1,   0,  3)
...
#define GPIO_output_open_drain_pull_up_fast(port,pins)                 GPIO_setup ((port), (pins), 1, (       0), 1,   1,  3)
...
#define GPIO_output_open_drain_pull_down_fast(port,pins)               GPIO_setup ((port), (pins), 1, (       0), 1,   2,  3)
...
#define GPIO_alternate_push_pull_fast(port,pins,function)              GPIO_setup ((port), (pins), 2, (function), 0,   0,  3)
...
#define GPIO_alternate_pull_up_fast(port,pins,function)                GPIO_setup ((port), (pins), 2, (function), 0,   1,  3)
...
#define GPIO_alternate_pull_down_fast(port,pins,function)              GPIO_setup ((port), (pins), 2, (function), 0,   2,  3)
...
#define GPIO_alternate_open_drain_fast(port,pins,function)             GPIO_setup ((port), (pins), 2, (function), 1,   0,  3)
...
#define GPIO_alternate_open_drain_pull_up_fast(port,pins,function)     GPIO_setup ((port), (pins), 2, (function), 1,   1,  3)
...
#define GPIO_alternate_open_drain_pull_down_fast(port,pins,function)   GPIO_setup ((port), (pins), 2, (function), 1,   2,  3)
...
#endif /* STM32F0XX_SIMPLE_GPIO_H_INCLUDED */
